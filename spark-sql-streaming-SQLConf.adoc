...
a| [[disabledV2StreamingMicroBatchReaders]] Used exclusively when `MicroBatchExecution` is requested for <<spark-sql-streaming-MicroBatchExecution.adoc#logicalPlan, analyzed logical plan>>
