...
=== [[initialPartitionOffsets]] Initial Partition Offsets -- `initialPartitionOffsets` Internal Lazy Property
...
`initialPartitionOffsets` is the initial partition offsets.
