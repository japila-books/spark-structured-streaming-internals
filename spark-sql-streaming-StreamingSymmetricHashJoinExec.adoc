...
* [[stateWatermarkPredicates]] <<spark-sql-streaming-JoinStateWatermarkPredicates.adoc#, JoinStateWatermarkPredicates>> for the <<left, left>> and <<right, right>> join sides
...
* `StreamingSymmetricHashJoinExec` is requested to <<shouldRunAnotherBatch, shouldRunAnotherBatch>>
