...
`StreamingSymmetricHashJoinExec` is a binary physical operator that...FIXME
...
`StreamingSymmetricHashJoinExec` is a <<spark-sql-streaming-StateStoreWriter.adoc#, StateStoreWriter>> that...FIXME
