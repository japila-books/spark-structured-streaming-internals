...
== (WIP) Stateful Stream Processing
...
. link:spark-sql-streaming-demo-groupBy-aggregation-append.adoc[Streaming Aggregation with Dataset.groupBy High-Level Operator and Append Output Mode]
