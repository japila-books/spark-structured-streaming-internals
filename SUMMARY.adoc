...
=== Aggregation and Arbitrary Stateful Stream Processing

. link:spark-sql-streaming-KeyValueGroupedDataset.adoc[KeyValueGroupedDataset -- (Stateful) Streaming Aggregation]
. link:spark-sql-streaming-GroupState.adoc[GroupState -- Contract for State Per Group For Arbitrary Stateful Aggregation]
