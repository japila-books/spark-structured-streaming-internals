...
.. link:spark-sql-streaming-StateStoreCoordinatorRef.adoc[StateStoreCoordinatorRef -- StateStoreCoordinator RPC Endpoint to StateStoreCoordinator]
...
. link:spark-sql-streaming-StateStoreHandler.adoc[StateStoreHandler Contract]
