...
. link:spark-sql-streaming-ContinuousReadSupport.adoc[ContinuousReadSupport Contract -- Data Source Factories of ContinuousReaders]
...
. link:spark-sql-streaming-RateStreamProvider.adoc[RateStreamProvider]
