...
=== [[stop]] Stopping Execution of Streaming Query -- `stop` Method
...
NOTE: `stop` is part of the <<spark-sql-streaming-StreamingQuery.adoc#stop, StreamingQuery Contract>> to stop execution of the streaming query.
