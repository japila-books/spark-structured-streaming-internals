...
CAUTION: FIXME Describe the committing (after `if (currentBatchId != 0) {`)

In the end, `constructNextBatch` purges <<offsetLog, OffsetSeqLog>> and <<batchCommitLog, batchCommitLog>>.
