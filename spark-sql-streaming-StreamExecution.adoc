...
`StreamExecution` uses <<offsetLog, OffsetSeqLog>> and <<batchCommitLog, BatchCommitLog>> internal registries to keep track of offsets to be processed and that have already been processed, respectively.
