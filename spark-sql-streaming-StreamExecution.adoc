...
=== [[lastExecution]] IncrementalExecution -- `lastExecution` Property
...
`lastExecution` is a <<spark-sql-streaming-IncrementalExecution.adoc#, IncrementalExecution>> of the most recent (_last_) execution.
