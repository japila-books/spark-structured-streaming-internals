...
+- StreamingSymmetricHashJoin [value#3L, time#2], [value#8L, time#7], Inner, condition = [ leftOnly = null, rightOnly = null, both = null, full = null ], state info [ checkpoint = <unknown>, runId = e4c7a2db-59b4-48ae-94d5-19986b81a222, opId = 0, ver = 0, numPartitions = 1], 0, state cleanup [ left = null, right = null ]
