...
NOTE: `sourceSchema` is a part of link:spark-sql-streaming-StreamSourceProvider.adoc#contract[StreamSourceProvider Contract].
...
=== [[createRelation]] Creating KafkaRelation -- `createRelation` Method
...
Internally, `createRelation`...FIXME
