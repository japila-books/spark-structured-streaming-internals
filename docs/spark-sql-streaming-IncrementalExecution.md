...
* [[outputMode]] <<spark-sql-streaming-OutputMode.md#, OutputMode>> (as specified using <<spark-sql-streaming-DataStreamWriter.md#outputMode, DataStreamWriter.outputMode>> method)
