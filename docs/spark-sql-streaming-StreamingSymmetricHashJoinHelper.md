...
NOTE: The <<spark-sql-streaming-EventTimeWatermark.md#delayKey, watermark attribute>> is defined using <<spark-sql-streaming-Dataset-operators.md#withWatermark, Dataset.withWatermark>> operator.
