...
The following demo shows the behaviour and the internals of [streaming watermark](../watermark/index.md) with a [streaming aggregation](../streaming-aggregation/index.md) in [Append](../OutputMode.md#Append) output mode.
